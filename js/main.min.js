 ...
 *
 * ========================================================== */(function(e){e.fn.pagepiling=function(t){function n(t){var n=e(".pp-section.active").index(".pp-section");return t=t.index(".pp-section"),n>t?"up":"down"}function r(r,s){var u={destination:r,animated:s,activeSection:e(".pp-section.active"),anchorLink:r.data("anchor"),sectionIndex:r.index(".pp-section"),toMove:r,yMovement:n(r),leavingSection:e(".pp-section.active").index(".pp-section")+1};u.activeSection.is(r)||("undefined"==typeof u.animated&&(u.animated=!0),"undefined"!=typeof u.anchorLink&&t.anchors.length&&(location.hash=u.anchorLink),u.destination.addClass("active").siblings().removeClass("active"),u.sectionsToMove=o(u),"down"===u.yMovement?(u.translate3d="vertical"!==t.direction?"translate3d(-100%, 0px, 0px)":"translate3d(0px, -100%, 0px)",u.scrolling="-100%",t.css3||u.sectionsToMove.each(function(t){t!=u.activeSection.index(".pp-section")&&e(this).css(a(u.scrolling))}),u.animateSection=u.activeSection):(u.translate3d="translate3d(0px, 0px, 0px)",u.scrolling="0",u.animateSection=r),e.isFunction(t.onLeave)&&t.onLeave.call(this,u.leavingSection,u.sectionIndex+1,u.yMovement),i(u),S(u.anchorLink),E(u.anchorLink,u.sectionIndex),N=u.anchorLink,C=(new Date).getTime())}function i(n){t.css3?(l(n.animateSection,n.translate3d,n.animated),n.sectionsToMove.each(function(){l(e(this),n.translate3d,n.animated)}),setTimeout(function(){s(n)},t.scrollingSpeed)):(n.scrollOptions=a(n.scrolling),n.animated?n.animateSection.animate(n.scrollOptions,t.scrollingSpeed,t.easing,function(){u(n),s(n)}):(n.animateSection.css(a(n.scrolling)),setTimeout(function(){u(n),s(n)},400)))}function s(n){e.isFunction(t.afterLoad)&&t.afterLoad.call(this,n.anchorLink,n.sectionIndex+1)}function o(t){return"down"===t.yMovement?e(".pp-section").map(function(n){if(n<t.destination.index(".pp-section"))return e(this)}):e(".pp-section").map(function(n){if(n>t.destination.index(".pp-section"))return e(this)})}function u(t){"up"===t.yMovement&&t.sectionsToMove.each(function(n){e(this).css(a(t.scrolling))})}function a(e){return"vertical"===t.direction?{top:e}:{left:e}}function f(){return(new Date).getTime()-C<600+t.scrollingSpeed?!0:!1}function l(e,t,n){e.toggleClass("pp-easing",n),e.css({"-webkit-transform":t,"-moz-transform":t,"-ms-transform":t,transform:t})}function c(t){if(!f()){t=window.event||t,t=Math.max(-1,Math.min(1,t.wheelDelta||-t.deltaY||-t.detail));var n=e(".pp-section.active"),n=p(n);return 0>t?h("down",n):h("up",n),!1}}function h(t,n){if("down"==t)var r="bottom",i=e.fn.pagepiling.moveSectionDown;else r="top",i=e.fn.pagepiling.moveSectionUp;if(0<n.length){if(!isScrolled(r,n))return!0;i()}else i()}function p(e){return scrollable=e.find(".pp-scrollable")}function d(){return window.PointerEvent?{down:"pointerdown",move:"pointermove",up:"pointerup"}:{down:"MSPointerDown",move:"MSPointerMove",up:"MSPointerUp"}}function v(e){var t=[];return window.navigator.msPointerEnabled?(t.y=e.pageY,t.x=e.pageX):(t.y=e.touches[0].pageY,t.x=e.touches[0].pageX),t}function m(e){e=v(e.originalEvent),L=e.y,touchStartX=e.x}function g(n){var r=n.originalEvent;y(n.target)||(n.preventDefault(),n=e(".pp-section.active"),n=p(n),f()||(r=v(r),touchEndY=r.y,touchEndX=r.x,"horizontal"===t.direction&&Math.abs(touchStartX-touchEndX)>Math.abs(L-touchEndY)?Math.abs(touchStartX-touchEndX)>T.width()/100*t.touchSensitivity&&(touchStartX>touchEndX?h("down",n):touchEndX>touchStartX&&h("up",n)):Math.abs(L-touchEndY)>T.height()/100*t.touchSensitivity&&(L>touchEndY?h("down",n):touchEndY>L&&h("up",n))))}function y(n,r){r=r||0;var i=e(n).parent();return r<t.normalScrollElementTouchThreshold&&i.is(t.normalScrollElements)?!0:r==t.normalScrollElementTouchThreshold?!1:y(i,++r)}function w(){e("body").append('<div id="pp-nav"><ul></ul></div>');var n=e("#pp-nav");n.css("color",t.navigation.textColor),n.addClass(t.navigation.position);for(var r=0;r<e(".pp-section").length;r++){var i="";t.anchors.length&&(i=t.anchors[r]);if("undefined"!=typeof t.navigation.tooltips){var s=t.navigation.tooltips[r];"undefined"==typeof s&&(s="")}n.find("ul").append('<li data-tooltip="'+s+'"><a href="#'+i+'"><span></span></a></li>')}n.find("span").css("border-color",t.navigation.bulletsColor)}function E(n,r){t.navigation&&(e("#pp-nav").find(".active").removeClass("active"),n?e("#pp-nav").find('a[href="#'+n+'"]').addClass("active"):e("#pp-nav").find("li").eq(r).find("a").addClass("active"))}function S(n){t.menu&&(e(t.menu).find(".active").removeClass("active"),e(t.menu).find('[data-menuanchor="'+n+'"]').addClass("active"))}function x(){var e=document.createElement("p"),t,n={webkitTransform:"-webkit-transform",OTransform:"-o-transform",msTransform:"-ms-transform",MozTransform:"-moz-transform",transform:"transform"};document.body.insertBefore(e,null);for(var r in n)void 0!==e.style[r]&&(e.style[r]="translate3d(1px,1px,1px)",t=window.getComputedStyle(e).getPropertyValue(n[r]));return document.body.removeChild(e),void 0!==t&&0<t.length&&"none"!==t}var T=e(this),N,C=0,k="ontouchstart"in window||0<navigator.msMaxTouchPoints,L=touchStartX=touchEndY=touchEndX=0;t=e.extend({direction:"vertical",menu:null,verticalCentered:!0,sectionsColor:[],anchors:[],scrollingSpeed:700,easing:"swing",loopBottom:!1,loopTop:!1,css3:!0,navigation:{textColor:"#000",bulletsColor:"#000",position:"right",tooltips:["section1","section2","section3","section4"]},normalScrollElements:null,normalScrollElementTouchThreshold:5,touchSensitivity:5,keyboardScrolling:!0,sectionSelector:".section",animateAnchor:!1,afterLoad:null,onLeave:null,afterRender:null},t),e.fn.pagepiling.setScrollingSpeed=function(e){t.scrollingSpeed=e},e.fn.pagepiling.setMouseWheelScrolling=function(e){e?T.get(0).addEventListener?(T.get(0).addEventListener("mousewheel",c,!1),T.get(0).addEventListener("wheel",c,!1)):T.get(0).attachEvent("onmousewheel",c):T.get(0).addEventListener?(T.get(0).removeEventListener("mousewheel",c,!1),T.get(0).removeEventListener("wheel",c,!1)):T.get(0).detachEvent("onmousewheel",c)},e.fn.pagepiling.setAllowScrolling=function(t){t?(e.fn.pagepiling.setMouseWheelScrolling(!0),k&&(MSPointer=d(),T.off("touchstart "+MSPointer.down).on("touchstart "+MSPointer.down,m),T.off("touchmove "+MSPointer.move).on("touchmove "+MSPointer.move,g))):(e.fn.pagepiling.setMouseWheelScrolling(!1),k&&(MSPointer=d(),T.off("touchstart "+MSPointer.down),T.off("touchmove "+MSPointer.move)))},e.fn.pagepiling.setKeyboardScrolling=function(e){t.keyboardScrolling=e},e.fn.pagepiling.moveSectionUp=function(){var n=e(".pp-section.active").prev(".pp-section");!n.length&&t.loopTop&&(n=e(".pp-section").last()),n.length&&r(n)},e.fn.pagepiling.moveSectionDown=function(){var n=e(".pp-section.active").next(".pp-section");!n.length&&t.loopBottom&&(n=e(".pp-section").first()),n.length&&r(n)},e.fn.pagepiling.moveTo=function(t){var n="",n=isNaN(t)?e('[data-anchor="'+t+'"]'):e(".pp-section").eq(t-1);0<n.length&&r(n)},e(t.sectionSelector).each(function(){e(this).addClass("pp-section")}),t.css3&&(t.css3=x()),e(T).css({overflow:"hidden","-ms-touch-action":"none","touch-action":"none"}),e.fn.pagepiling.setAllowScrolling(!0),e.isEmptyObject(t.navigation)||w();var A=e(".pp-section").length;e(".pp-section").each(function(n){e(this).data("data-index",n),e(this).css("z-index",A),n||0!==e(".pp-section.active").length||e(this).addClass("active"),"undefined"!=typeof t.anchors[n]&&e(this).attr("data-anchor",t.anchors[n]),"undefined"!=typeof t.sectionsColor[n]&&e(this).css("background-color",t.sectionsColor[n]),t.verticalCentered&&e(this).addClass("pp-table").wrapInner('<div class="pp-tableCell" style="height:100%" />'),--A}).promise().done(function(){t.navigation&&(e("#pp-nav").css("margin-top","-"+e("#pp-nav").height()/2+"px"),e("#pp-nav").find("li").eq(e(".pp-section.active").index(".pp-section")).find("a").addClass("active")),e(window).on("load",function(){var n=window.location.hash.replace("#",""),n=e('.pp-section[data-anchor="'+n+'"]');0<n.length&&r(n,t.animateAnchor)}),e.isFunction(t.afterRender)&&t.afterRender.call(this)}),e(window).on("hashchange",function(){var t=window.location.hash.replace("#","").split("/")[0];t.length&&t&&t!==N&&(t=isNaN(t)?e('[data-anchor="'+t+'"]'):e(".pp-section").eq(t-1),r(t))}),e(document).keydown(function(n){if(t.keyboardScrolling&&!f())switch(n.which){case 38:case 33:e.fn.pagepiling.moveSectionUp();break;case 40:case 34:e.fn.pagepiling.moveSectionDown();break;case 36:e.fn.pagepiling.moveTo(1);break;case 35:e.fn.pagepiling.moveTo(e(".pp-section").length);break;case 37:e.fn.pagepiling.moveSectionUp();break;case 39:e.fn.pagepiling.moveSectionDown()}}),t.normalScrollElements&&(e(document).on("mouseenter",t.normalScrollElements,function(){e.fn.pagepiling.setMouseWheelScrolling(!1)}),e(document).on("mouseleave",t.normalScrollElements,function(){e.fn.pagepiling.setMouseWheelScrolling(!0)})),e(document).on("click touchstart","#pp-nav a",function(t){t.preventDefault(),t=e(this).parent().index(),r(e(".pp-section").eq(t))}),e(document).on({mouseenter:function(){var n=e(this).data("tooltip");e('<div class="pp-tooltip '+t.navigation.position+'">'+n+"</div>").hide().appendTo(e(this)).fadeIn(200)},mouseleave:function(){e(this).find(".pp-tooltip").fadeOut(200,function(){e(this).remove()})}},"#pp-nav li")}})(jQuery);window.mobilecheck=function(){var e=!1;return function(t,n){if(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(t)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(t.substr(0,4)))e=!0}(navigator.userAgent||navigator.vendor||window.opera),e},$(document).ready(function(){var e=mobilecheck(),t=["Home","Projects","Professions","Education","Work Experience","Jobs Preferred","Contact Me"],n=["首页","项目","技能","教育","工作","求职","联系"],r=window.location.href.indexOf("cn.html")>=0;$(".section").addClass("initing"),$(".initing").removeClass("initing"),$("#pagepiling").pagepiling({loopBottom:!0,navigation:{position:e?"right":"left",tooltips:r?n:t},onLeave:function(e,t,n){var r=$(".section");for(var i=0;i<r.length;++i)i+1!==t?$(r[i]).addClass("leaving"):$(r[i]).removeClass("leaving")}})});